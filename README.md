...
A Meteor client addon for finding stashes and bases on anarchy servers. This mod is designed to help players discover new stashes by tracking player-placed blocks.
...
- **Customizable Commands**:
    ...
    - `.clear-stashes`: Clears the list of found stashes.
    - `.clear-players`: Clears the list of tracked players.
...
-   `.clear-stashes`: Deletes all saved stash locations.
-   `.clear-players`: Deletes all tracked player data.
