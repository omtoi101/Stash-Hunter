...
public class SafeLandingSpotFinder {
    ...
    public static BlockPos findLandingSpot(Vec3d startPos, int radius, ClientWorld world, boolean findBest) {
    ...
    public static int evaluateLandingSpotSafety(BlockPos pos, ClientWorld world) {
        ...
        try {
            ...
            // Penalty for being too high above
